...
samp_names
factor1_lst <- str_extract(samp_names, "^[^_]+")

# getting second element of list of arrays
# taken from 
factor2_lst <- sapply(str_split(samp_names, "_"), "[[", 2)
...
contrasts_as_str <- sapply(as.data.frame(combn(unique(paste0(factor1, factor1_lst)), 2)), function(comp) paste0(comp[1],"-",comp[2]))
