...
#orgdb <- annot_config %>% filter(common_name == 'worm') %>% select(org.db)
#
...
#message(paste0("orgdbname: '",orgdbname, "'"))
#message(paste("orgdbname type:", typeof(orgdbname)))
#orgdbname <- "org.Ce.eg.db"
#message('stopping before orgdb')
#stop()
